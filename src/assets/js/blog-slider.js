...
(function() {
    ...
    function initBlogSlider() {
        ...
        sliderInstance = new KeenSlider(sliderElement, {
            ...
            breakpoints: {
                '(min-width: 34.375rem)': { // 550px - tablet
                    slides: {
                        perView: 1.6,
                        spacing: 16,
                    },
        ...
        const overlay = document.getElementById('blog-slider-overlay');
        if (overlay) {
        ...
        const prevButton = document.querySelector('#blog-986 .cs-slider-prev');
        const nextButton = document.querySelector('#blog-986 .cs-slider-next');
